      ...
      <div className="myContainer">
        <div className="topMenu">
          ...
          <div className="search">
            <input type="text" placeholder="Xin chào, bạn muốn tìm gì hôm nay?" />
        ...
        <div className="mainContent">
          <div className="proItem">
            <div className="hinhAnh">
              <img src="https://acecookvietnam.vn/wp-content/uploads/2017/07/H%E1%BA%A3o-H%E1%BA%A3o-T%C3%B4m-chua-cay_down33_.png" alt="" />
            </div>
            <div className="text">
              <div className="tenSp">
                <p>Gói mì hảo hảo</p>
